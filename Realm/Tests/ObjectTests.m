...
- (void)testCreateInRealmWithCircularObject
{
    ...
    object.data = @"data";
    object.next = [[CircleObject alloc] initWithObject:@[@"other data", object]];

    [realm beginWriteTransaction];
    [CircleObject createInRealm:realm withObject:object];
    [realm commitWriteTransaction];
}
...
- (void)testInitCircularObject
{
    ...
    [realm beginWriteTransaction];
    CircleObject *standalone = [[CircleObject alloc] initWithObject:value];
    [realm commitWriteTransaction];
